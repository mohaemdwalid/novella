...
if (cartDrawer) {
  sectionsToRender.push(getSectionData('#CartDrawer-Body', 'cart-drawer', '#shopify-section-cart-drawer #CartDrawer-Body'));
}

if (mainCartId) {
  sectionsToRender.push(getSectionData(`#shopify-section-${mainCartId}`, mainCartId, `#shopify-section-${mainCartId} cart-items`));
  sectionsToRender.push(getSectionData('#cart-counter', 'cart-counter', '#shopify-section-cart-counter'));
}
