...
class DynamicLoad extends HTMLElement {
  constructor() {
    ...
    this.gridType = gridTypes[this.itemGrid.id] || "unknown";
    ...
    async loadMoreItems() {
      ...
      try {
        ...
        if (this.gridType === "product") {
          newGridContainer = htmlDoc.querySelector("#ProductGridContainer");
        } else if (this.gridType === "collection") {
          newGridContainer = htmlDoc.querySelector("#CollectionGridContainer");
        } else if (this.gridType === "article") {
          newGridContainer = htmlDoc.querySelector("#ArticleGridContainer");
        }
        ...
        const nextButtonOnNewPage = htmlDoc.querySelector(
          ".js-btn-load-more"
        );
  ...
  class DynamicLoadPrevious extends DynamicLoad {
    ...
    async loadPreviousItems() {
      ...
      try {
        ...
        const prevButtonOnNewPage = htmlDoc.querySelector(
