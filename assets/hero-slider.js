if (!customElements.get('hero-slider')) {
  class HeroSlider extends SwiperComponent {
    ...
    handleSlideChange(swiper) {
      ...
      let heroInners = document.querySelectorAll('.hero-banner__inner');
    ...
    handleSlideChangeAnimations(swiper) {
      ...
      const queryArray = [...(swiper.wrapperEl.querySelector(queryElement).querySelectorAll('.hero-banner__animation') || [])];
      if (!queryArray.length) {
        return;
      }
      const allowMobileAnimation = swiper.wrapperEl.closest('.hero-banner__content')?.dataset.animationMobile === 'true';
