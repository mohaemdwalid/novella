class NewsletterPopup extends ModalDialog {
  ...
  handlePopupVisibility() {
    const requiresAgeVerification = getCookie("age-verified") !== "true" && this.ageVerificationPopup;
  ...
  showPopupWithDelay() {
    setTimeout(() => {
      const isClosed = this.closed === "true";
      const isSubscribed = this.subscribed === "true";
  ...
  init() {
    this.delay = (this.dataset.delay || 0) * 1000;
