    ...
    constructor() {
      ...
      this.input.addEventListener('input', e => {
        ...
        this.timeout = setTimeout(() => {
          ...
          const isMobileDevice = DeviceDetector.isMobile() || DeviceDetector.isTablet();

          if (query.length === 0) {
            this.close();
            if (isMobileDevice) searchDrawerContent.style.height = 'auto';
          ...
          if (isMobileDevice) searchDrawerContent.style.height = '100%';
